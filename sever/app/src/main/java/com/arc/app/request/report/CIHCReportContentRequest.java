...
@Getter
@Setter
public class CIHCReportContentRequest {
    private Long id;
    ...
    public CIHCReportContentRequest(CIHCReportContent entity) {
        if (entity != null) {
    ...
    public CIHCReportContentRequest(Long id, String title, Integer indexNumber, Integer reportNumber, String subContent, Boolean bold, Boolean italics, Boolean canWrite,
