...
@Getter
@Setter
public class HIReportContentRequest {
    private Long id;
    ...
    public HIReportContentRequest(HIReportContent entity) {
        if (entity != null) {
    ...
    public HIReportContentRequest(Long id, String title, Integer indexNumber, Integer reportNumber, String subContent, Boolean bold, Boolean italics, Boolean canWrite,
