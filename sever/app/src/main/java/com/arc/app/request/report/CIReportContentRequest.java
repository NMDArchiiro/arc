...
@Getter
@Setter
public class CIReportContentRequest {
    private Long id;
    ...
    public CIReportContentRequest(CIReportContent entity) {
        if (entity != null) {
    ...
    public CIReportContentRequest(Long id, String title, Integer indexNumber, Integer reportNumber, String subContent, Boolean bold, Boolean italics, Boolean canWrite,
